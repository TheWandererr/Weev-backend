...
public class FirebasePushNotificationsFactory {

    private final MessageBundle messageBundle;
    private final Gson gson;

    public FirebasePushNotificationMessage build(String titleCode,
                                                 Object[] titleArgs,
                                                 String bodyCode,
                                                 Object[] bodyArgs,
        ...
        return new FirebasePushNotificationMessage(title, body, data, notificationTokens);
    }
}
