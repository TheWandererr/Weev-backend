...
import com.pivo.weev.backend.websocket.factory.WsMessageFactory;
...
public class WebSocketMessageEventListener {
    ...
    private final WsMessageFactory wsMessageFactory;
    ...
    public void onWebSocketMessageEventPublishing(WebSocketMessageEvent event) {
        ...
        if (messageModel.hasDestination()) {
            EventMessageWs message = wsMessageFactory.createMessage(messageModel);
