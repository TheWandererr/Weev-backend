...
import static com.pivo.weev.backend.domain.persistance.utils.Constants.Columns.MEET_CATEGORY_NAME;
...
@Entity
@Table(name = "meet_categories")
@SequenceGenerator(sequenceName = "meet_category_id_sequence", allocationSize = 1, name = "sequence_generator")
@Getter
@Setter
public class CategoryJpa extends SequencedPersistable<Long> {

    @Column(name = MEET_CATEGORY_NAME, unique = true)
    private String name;
